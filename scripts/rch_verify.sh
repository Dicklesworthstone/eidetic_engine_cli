...
materialize_pinned_franken_stack() {
    ...
    # Captured sibling trees are immutable. SQLModel 0.5.0 already declares
    # asupersync 0.5.0; rewriting Cargo.toml after archive would make the
    # pinned bundle differ from franken-stack.lock (bd-1azkt.18).
