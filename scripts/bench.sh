...
case "$PROFILE" in
    ci-smoke)
        ...
        ;;
    nightly)
        BENCHMARKS="remember search context pack_size why outcome status workspace_init audit_query index_rebuild concurrent_writes import_cass link graph_pagerank graph_ppr graph_louvain graph_ktruss graph_gomory_hu graph_hits curate_candidates graph_refresh_cooperative"
