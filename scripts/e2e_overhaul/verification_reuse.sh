...
cat > "$J1_LOG" <<'JSONL'
{"schema":"ee.test_event.v1","ts":"2026-05-21T18:00:00Z","test_id":"focused_rch_a","kind":"command_end","command":"cargo","args":["cargo","test","--test","verification_evidence_schema_unit","reuse_advisory","--","--nocapture"],"stdout_hash":"blake3:stdout-focused-a","stderr_excerpt":"remote worker worker-c passed","exit_code":0,"elapsed_ms":42000.0}
{"schema":"ee.test_event.v1","ts":"2026-05-21T18:00:01Z","test_id":"focused_rch_a","kind":"artifact_manifest","fields":{"manifest_schema":"ee.test_artifact_manifest.v1","phase":"command_end","bead_id":"bd-1zb7k.15.5","agent_name":"CalmBay","source_hash":"blake3:source-current","command_hash":"blake3:focused-command","command_arg_count":"7","execution_substrate":"rch","worker_host":"worker-c","target_directory":"/Volumes/USBNVME16TB/temp_agent_space/rch-target-focused-a","log_path":"/tmp/verification-reuse-focused-a.jsonl","artifact_manifest_hash":"blake3:manifest-focused-a"}}
{"schema":"ee.test_event.v1","ts":"2026-05-21T18:01:00Z","test_id":"focused_rch_b","kind":"command_end","command":"cargo","args":["cargo","test","--test","verification_evidence_schema_unit","reuse_advisory","--","--nocapture"],"stdout_hash":"blake3:stdout-focused-b","stderr_excerpt":"remote worker worker-b passed","exit_code":0,"elapsed_ms":39000.0}
{"schema":"ee.test_event.v1","ts":"2026-05-21T18:01:01Z","test_id":"focused_rch_b","kind":"artifact_manifest","fields":{"manifest_schema":"ee.test_artifact_manifest.v1","phase":"command_end","bead_id":"bd-1zb7k.15.5","agent_name":"RoseHill","source_hash":"blake3:source-current","command_hash":"blake3:focused-command","command_arg_count":"7","execution_substrate":"rch","worker_host":"worker-b","target_directory":"/Volumes/USBNVME16TB/temp_agent_space/rch-target-focused-b","log_path":"/tmp/verification-reuse-focused-b.jsonl","artifact_manifest_hash":"blake3:manifest-focused-b"}}
{"schema":"ee.test_event.v1","ts":"2026-05-21T17:45:00Z","test_id":"focused_rch_stale","kind":"command_end","command":"cargo","args":["cargo","test","--test","verification_evidence_schema_unit","reuse_advisory","--","--nocapture"],"stdout_hash":"blake3:stdout-stale","stderr_excerpt":"remote worker worker-c passed on old source","exit_code":0,"elapsed_ms":41000.0}
{"schema":"ee.test_event.v1","ts":"2026-05-21T17:45:01Z","test_id":"focused_rch_stale","kind":"artifact_manifest","fields":{"manifest_schema":"ee.test_artifact_manifest.v1","phase":"command_end","bead_id":"bd-1zb7k.15.5","agent_name":"RubyWolf","source_hash":"blake3:source-stale","command_hash":"blake3:focused-command","command_arg_count":"7","execution_substrate":"rch","worker_host":"worker-c","target_directory":"/Volumes/USBNVME16TB/temp_agent_space/rch-target-stale","log_path":"/tmp/verification-reuse-stale.jsonl","artifact_manifest_hash":"blake3:manifest-stale"}}
