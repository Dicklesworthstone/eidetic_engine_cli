...
fn installer_targets_match_release_matrix() -> TestResult {
    ...
    for required in [
        ...
        "unix_installer_warns_on_missing_sigstore_by_default",
        ...
        "windows_installer_requires_sha256_by_default",
        "windows_installer_noverify_skips_verification",
        "windows_installer_fails_on_bad_sigstore",
        "windows_installer_requires_sigstore_bundle_with_cosign",
        "windows_installer_warns_on_missing_sigstore_by_default",
        "windows_installer_supports_required_provenance",
        "windows_installer_honors_required_provenance_env",
