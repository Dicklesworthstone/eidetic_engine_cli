...
fn posterior(alpha: f64, beta: f64) -> BetaPosterior {
    BetaPosterior::new(alpha, beta).expect("valid posterior fixture")
}
...
#[test]
fn trust_class_transition_table_promotes_on_ci_lower_crossings() {
...
#[test]
fn trust_class_transition_table_demotes_on_ci_upper_crossings() {
...
#[test]
fn legacy_import_promotion_requires_validation_event() {
    assert_transition(
        TrustClass::LegacyImport,
        posterior(30.0, 1.0),
        0,
...
#[test]
fn agent_assertion_promotion_requires_sample_size_gate() {
...
#[test]
fn human_explicit_promotion_requires_operator_intent() {
    let strong_positive = posterior(30.0, 1.0);
...
#[test]
fn neutral_posterior_does_not_emit_transition_audit() {
    let transition =
        trust_class_transition(TrustClass::AgentAssertion, &posterior(2.0, 2.0), 0, false);
