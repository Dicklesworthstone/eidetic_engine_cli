...
| Production IdP vendor soak | `bd-tc-epic-qzk7o.8.8` **closed 2026-08-17** | Fake-IdP RS256 + live `identity_attest` is the v1 ceiling. No Entra/Okta/Google secretless public client exists in this environment. T7.1–T7.7 (preflight, constrained HTTPS device client, JWKS verify, token-free attestation, fake harness) remain shipped. A later vendor soak is a new bead, not a v1 blocker. |
| Program closeout | `bd-tc-epic-qzk7o.7.7` (T6.7) | Closes after the T5.7 fence (`.6.7` / `bd-d67os.28`) and this rollup. IdP vendor soak is decided, not deferred as a v1 hole. |
