...
exit 0. Isolated 2026-08-15: `cargo bench --bench
team_confed` Finished 68m 21s EXIT 0 (derive_pair_key ~2 µs,
admission ~80 ns, create_and_enroll ~34 s migrate-dominated).
Windows inbound listen and a Windows-host DACL soak remain out of
scope. Do not self-close beads from this ledger.
