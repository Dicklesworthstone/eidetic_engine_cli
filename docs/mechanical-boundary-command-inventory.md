...
164 stable command paths returned by the command-path extractor.

E2E audit record for this inventory:

- Command source: `src/cli/mod.rs`
- Command path count: 164
