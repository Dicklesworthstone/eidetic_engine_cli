...
# unset EE_MESH_HELLO_PORT if it still pins the previous port
...
# search/pack/ask/why carry teamProvenance; activity lists member + project + origin time + bodyAvailable
```
