...
pub use merge::{
    ...
    HANDOFF_STALE_MEMORIES_ADDED_KEY, HANDOFF_STALE_MEMORIES_REVISED_KEY, JOURNAL_ENABLED_KEY,
    JOURNAL_RETENTION_DAYS_KEY, LEARN_CLUSTER_COHERENCE_THRESHOLD_KEY,
