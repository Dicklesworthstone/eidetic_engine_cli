    ...
    mod roster_ownership_tests {
        ...
        fn caller_snapshot_retains_membership_until_release_then_observes_revocation() {
            ...
            assert!(
                fixture
                    .writer
                    .set_team_member_state(&member, "removed")
                    .unwrap()
            );
            assert!(
                fixture
            ...
            reader
                ...
                .expect("scope read must not release the caller's snapshot");
        ...
        fn failed_workspace_authority_never_falls_back_to_unfiltered_membership() {
            ...
            fixture
                .writer
                .execute_raw("ALTER TABLE workspaces RENAME TO unavailable_roster_workspaces")
                .unwrap();
