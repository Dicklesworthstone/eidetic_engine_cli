...
pub const ENV_VARS: &[EnvVarEntry] = &[
    ...
    EnvVarEntry {
        name: EnvVar::AdaptiveBackoffMs.name(),
        description: EnvVar::AdaptiveBackoffMs.description(),
        default: EnvVar::AdaptiveBackoffMs.default_value(),
        category: EnvVar::AdaptiveBackoffMs.category(),
    },
    EnvVarEntry {
        name: EnvVar::AdaptiveNoisyP99Ms.name(),
        description: EnvVar::AdaptiveNoisyP99Ms.description(),
        default: EnvVar::AdaptiveNoisyP99Ms.default_value(),
        category: EnvVar::AdaptiveNoisyP99Ms.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::CurationAutoPromoteConfidenceFloor.name(),
        description: EnvVar::CurationAutoPromoteConfidenceFloor.description(),
        default: EnvVar::CurationAutoPromoteConfidenceFloor.default_value(),
        category: EnvVar::CurationAutoPromoteConfidenceFloor.category(),
    },
    EnvVarEntry {
        name: EnvVar::CurationAutoPromoteMaxPerRun.name(),
        description: EnvVar::CurationAutoPromoteMaxPerRun.description(),
        default: EnvVar::CurationAutoPromoteMaxPerRun.default_value(),
        category: EnvVar::CurationAutoPromoteMaxPerRun.category(),
    },
    EnvVarEntry {
        name: EnvVar::CurationDerivedPreviewLimit.name(),
        description: EnvVar::CurationDerivedPreviewLimit.description(),
        default: EnvVar::CurationDerivedPreviewLimit.default_value(),
        category: EnvVar::CurationDerivedPreviewLimit.category(),
    },
    EnvVarEntry {
        name: EnvVar::DaemonEnableEcho.name(),
        description: EnvVar::DaemonEnableEcho.description(),
        default: EnvVar::DaemonEnableEcho.default_value(),
        category: EnvVar::DaemonEnableEcho.category(),
    },
    EnvVarEntry {
        name: EnvVar::DaemonMaxInflight.name(),
        description: EnvVar::DaemonMaxInflight.description(),
        default: EnvVar::DaemonMaxInflight.default_value(),
        category: EnvVar::DaemonMaxInflight.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::DisableAdaptive.name(),
        description: EnvVar::DisableAdaptive.description(),
        default: EnvVar::DisableAdaptive.default_value(),
        category: EnvVar::DisableAdaptive.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::GraphMemoryDegradedBelowPct.name(),
        description: EnvVar::GraphMemoryDegradedBelowPct.description(),
        default: EnvVar::GraphMemoryDegradedBelowPct.default_value(),
        category: EnvVar::GraphMemoryDegradedBelowPct.category(),
    },
    EnvVarEntry {
        name: EnvVar::GraphMemoryGrowthMultiplierBasisPoints.name(),
        description: EnvVar::GraphMemoryGrowthMultiplierBasisPoints.description(),
        default: EnvVar::GraphMemoryGrowthMultiplierBasisPoints.default_value(),
        category: EnvVar::GraphMemoryGrowthMultiplierBasisPoints.category(),
    },
    EnvVarEntry {
        name: EnvVar::GraphMemoryPerAlgorithmCapMb.name(),
        description: EnvVar::GraphMemoryPerAlgorithmCapMb.description(),
        default: EnvVar::GraphMemoryPerAlgorithmCapMb.default_value(),
        category: EnvVar::GraphMemoryPerAlgorithmCapMb.category(),
    },
    EnvVarEntry {
        name: EnvVar::GraphMemorySnapshotCapMb.name(),
        description: EnvVar::GraphMemorySnapshotCapMb.description(),
        default: EnvVar::GraphMemorySnapshotCapMb.default_value(),
        category: EnvVar::GraphMemorySnapshotCapMb.category(),
    },
    EnvVarEntry {
        name: EnvVar::GraphNumaPinDisable.name(),
        description: EnvVar::GraphNumaPinDisable.description(),
        default: EnvVar::GraphNumaPinDisable.default_value(),
        category: EnvVar::GraphNumaPinDisable.category(),
    },
    EnvVarEntry {
        name: EnvVar::GraphNumaPinNode.name(),
        description: EnvVar::GraphNumaPinNode.description(),
        default: EnvVar::GraphNumaPinNode.default_value(),
        category: EnvVar::GraphNumaPinNode.category(),
    },
    EnvVarEntry {
        name: EnvVar::GraphNumaPinPopulate.name(),
        description: EnvVar::GraphNumaPinPopulate.description(),
        default: EnvVar::GraphNumaPinPopulate.default_value(),
        category: EnvVar::GraphNumaPinPopulate.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::MaxOutputTokens.name(),
        description: EnvVar::MaxOutputTokens.description(),
        default: EnvVar::MaxOutputTokens.default_value(),
        category: EnvVar::MaxOutputTokens.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::McpMaxRequestBytes.name(),
        description: EnvVar::McpMaxRequestBytes.description(),
        default: EnvVar::McpMaxRequestBytes.default_value(),
        category: EnvVar::McpMaxRequestBytes.category(),
    },
    EnvVarEntry {
        name: EnvVar::MeshDiscoveryCacheTtlSeconds.name(),
        description: EnvVar::MeshDiscoveryCacheTtlSeconds.description(),
        default: EnvVar::MeshDiscoveryCacheTtlSeconds.default_value(),
        category: EnvVar::MeshDiscoveryCacheTtlSeconds.category(),
    },
    EnvVarEntry {
        name: EnvVar::MeshDriftSoftStaleAfter.name(),
        description: EnvVar::MeshDriftSoftStaleAfter.description(),
        default: EnvVar::MeshDriftSoftStaleAfter.default_value(),
        category: EnvVar::MeshDriftSoftStaleAfter.category(),
    },
    EnvVarEntry {
        name: EnvVar::MeshDriftSoftStaleAfterSeconds.name(),
        description: EnvVar::MeshDriftSoftStaleAfterSeconds.description(),
        default: EnvVar::MeshDriftSoftStaleAfterSeconds.default_value(),
        category: EnvVar::MeshDriftSoftStaleAfterSeconds.category(),
    },
    EnvVarEntry {
        name: EnvVar::MeshDriftHardStaleAfter.name(),
        description: EnvVar::MeshDriftHardStaleAfter.description(),
        default: EnvVar::MeshDriftHardStaleAfter.default_value(),
        category: EnvVar::MeshDriftHardStaleAfter.category(),
    },
    EnvVarEntry {
        name: EnvVar::MeshDriftHardStaleAfterSeconds.name(),
        description: EnvVar::MeshDriftHardStaleAfterSeconds.description(),
        default: EnvVar::MeshDriftHardStaleAfterSeconds.default_value(),
        category: EnvVar::MeshDriftHardStaleAfterSeconds.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::MeshHelloPort.name(),
        description: EnvVar::MeshHelloPort.description(),
        default: EnvVar::MeshHelloPort.default_value(),
        category: EnvVar::MeshHelloPort.category(),
    },
    EnvVarEntry {
        name: EnvVar::MeshHelloResponderDisabled.name(),
        description: EnvVar::MeshHelloResponderDisabled.description(),
        default: EnvVar::MeshHelloResponderDisabled.default_value(),
        category: EnvVar::MeshHelloResponderDisabled.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::ReflectionConsumedRetentionDays.name(),
        description: EnvVar::ReflectionConsumedRetentionDays.description(),
        default: EnvVar::ReflectionConsumedRetentionDays.default_value(),
        category: EnvVar::ReflectionConsumedRetentionDays.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionExpiredRetentionDays.name(),
        description: EnvVar::ReflectionExpiredRetentionDays.description(),
        default: EnvVar::ReflectionExpiredRetentionDays.default_value(),
        category: EnvVar::ReflectionExpiredRetentionDays.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionHmacKeyId.name(),
        description: EnvVar::ReflectionHmacKeyId.description(),
        default: EnvVar::ReflectionHmacKeyId.default_value(),
        category: EnvVar::ReflectionHmacKeyId.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionHmacKeyPath.name(),
        description: EnvVar::ReflectionHmacKeyPath.description(),
        default: EnvVar::ReflectionHmacKeyPath.default_value(),
        category: EnvVar::ReflectionHmacKeyPath.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionHmacRotationGraceSeconds.name(),
        description: EnvVar::ReflectionHmacRotationGraceSeconds.description(),
        default: EnvVar::ReflectionHmacRotationGraceSeconds.default_value(),
        category: EnvVar::ReflectionHmacRotationGraceSeconds.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionRequestListLimit.name(),
        description: EnvVar::ReflectionRequestListLimit.description(),
        default: EnvVar::ReflectionRequestListLimit.default_value(),
        category: EnvVar::ReflectionRequestListLimit.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionRequestShowSourceLimit.name(),
        description: EnvVar::ReflectionRequestShowSourceLimit.description(),
        default: EnvVar::ReflectionRequestShowSourceLimit.default_value(),
        category: EnvVar::ReflectionRequestShowSourceLimit.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionRequestTtlSeconds.name(),
        description: EnvVar::ReflectionRequestTtlSeconds.description(),
        default: EnvVar::ReflectionRequestTtlSeconds.default_value(),
        category: EnvVar::ReflectionRequestTtlSeconds.category(),
    },
    EnvVarEntry {
        name: EnvVar::ReflectionSourceBudgetBytes.name(),
        description: EnvVar::ReflectionSourceBudgetBytes.description(),
        default: EnvVar::ReflectionSourceBudgetBytes.default_value(),
        category: EnvVar::ReflectionSourceBudgetBytes.category(),
    },
    EnvVarEntry {
    ...
    EnvVarEntry {
        name: EnvVar::ServeToken.name(),
        description: EnvVar::ServeToken.description(),
        default: EnvVar::ServeToken.default_value(),
        category: EnvVar::ServeToken.category(),
    },
    EnvVarEntry {
