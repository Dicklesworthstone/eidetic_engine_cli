...
mod tests {
    ...
    use super::{
        AGENT_CORE_COMMANDS, AGENT_DOC_RECIPES, ASK_RECIPE_FAILURES, AgentDocsTopic, CONTRACTS,
        DECIDE_LIST_SCHEMA_V1, DECIDE_RECORD_SCHEMA_V1, DECIDE_REVISIT_SCHEMA_V1, DEFAULT_PATHS,
        EXAMPLES, EXIT_CODES, FIELD_LEVELS, GUIDE_SECTIONS, OUTPUT_FORMATS,
        TASK_LENS_RECIPE_FAILURES, env_var_entries,
    };
    use crate::config::EnvVar;
