...
pub use schema::{
    ...
    EMBEDDING_POSTURE_MODE_NEURAL_LOCAL, EMBEDDING_POSTURE_MODE_NEURAL_REMOTE_BLOCKED,
    EMBEDDING_POSTURE_SCHEMA_V1, INDEX_INTAKE_FALLBACK_DELTA_OVER_THRESHOLD,
    ...
    INDEX_INTAKE_SCHEMA_V1, KNOWN_SCHEMAS, SCALE_ENVELOPE_SCHEMA_V1,
