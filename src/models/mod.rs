...
pub use schema::{
    AMBIENT_CONTEXT_SCHEMA_V1, COVERAGE_GAP_SCHEMA_V1, EMBEDDING_POSTURE_MODE_DETERMINISTIC_HASH,
    ...
    GLOBAL_MEMORY_SCHEMA_V1, HOTSET_MANIFEST_SCHEMA_V1, INDEX_INTAKE_FALLBACK_DELTA_OVER_THRESHOLD,
