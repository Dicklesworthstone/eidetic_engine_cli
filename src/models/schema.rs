...
use super::{
    ...
    TAG_BACKFILL_LOG_SCHEMA_V1, TAG_BACKFILL_SCHEMA_V1, TAIL_RISK_RESERVE_RULE_SCHEMA_V1,
    TASK_SIGNATURE_SCHEMA_V1, TEST_EVENT_SCHEMA_V1, UNCERTAINTY_ESTIMATE_SCHEMA_V1,
...
pub const KNOWN_SCHEMAS: &[&str] = &[
    ...
    TAG_BACKFILL_SCHEMA_V1,
    TAG_BACKFILL_LOG_SCHEMA_V1,
